...
using System.Data;
using System.Linq;
using MyRepository = test.Administration.Repositories.UserPermissionRepository;
using MyRow = test.Administration.Entities.UserPermissionRow;

namespace test.Administration.Endpoints
{
