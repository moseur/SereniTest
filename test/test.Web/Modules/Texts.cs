	...
	public static partial class Texts
	{
		...
		public static class Forms
		{
			public static class Membership
			{
				...
				{
					public static LocalText EmailSubject = "Reset Your test Password";
				...
				{
					public static LocalText ActivateEmailSubject = "Activate Your test Account";
		...
		public static class Navigation
		{
			...
			public static LocalText SiteTitle = "test";
		}
